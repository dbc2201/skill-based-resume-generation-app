...
@Component({
    ...
    imports: [RouterLink, ContactFormComponent, SkillsFormComponent, NavbarComponent, FooterFormComponent, AlertFormComponent, PopoverFormComponent, ProfileFormComponent, DemoFormComponent]
})
